...
srun python3 geo_inference_t2i_autoreg.py config=configs/formalgeo-autoreg-32Down-512x512-t2i-0117/test.yaml \
batch_size=16 validation_prompts_file=data/formalgeo7k/formalgeo7k_v2/custom_json/t2i/test_2cdl2i.json \
output_dir=outputs/formalgeo-autoreg-32Down-512x512-t2i-0117/gen_imgs_2cdl2i \
mode='t2i'

srun python3 geo_inference_t2i_autoreg.py config=configs/formalgeo-autoreg-32Down-512x512-t2i-0117/test.yaml \
batch_size=16 validation_prompts_file=data/formalgeo7k/formalgeo7k_v2/custom_json/t2i/test_caption2i.json \
output_dir=outputs/formalgeo-autoreg-32Down-512x512-t2i-0117/gen_imgs_caption2i \
mode='t2i'

srun python3 geo_inference_t2i_autoreg.py config=configs/formalgeo-autoreg-32Down-512x512-t2i-0117/test.yaml \
batch_size=16 validation_prompts_file=data/formalgeo7k/formalgeo7k_v2/custom_json/t2i/test_caption_2cdl2i.json \
output_dir=outputs/formalgeo-autoreg-32Down-512x512-t2i-0117/gen_imgs_caption_2cdl2i \
mode='t2i'