...
#SBATCH --qos=low
#SBATCH -J Infer-reasoning-32down
#SBATCH --nodes=1    
...
output_dir='outputs/model_predict/geouni-512x512-0312-32down' \
...
max_new_tokens=3000 \
mmu_image_root='./data' \
validation_prompts_file=data/geouni_mixing_data/reasoningtest_reasoning_en.jsonl \
output_dir='outputs/model_predict/geouni-512x512-0312-32down' \
...
max_new_tokens=3000 \
mmu_image_root='./data' \
validation_prompts_file=data/geouni_mixing_data/reasoningtest_reasoning_choice_cn.jsonl \
output_dir='outputs/model_predict/geouni-512x512-0312-32down' \
...
max_new_tokens=3000 \
mmu_image_root='./data' \
validation_prompts_file=data/geouni_mixing_data/reasoningtest_reasoning_choice_en.jsonl \
output_dir='outputs/model_predict/geouni-512x512-0312-32down' \
