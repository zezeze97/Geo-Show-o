...
#SBATCH --qos=low
#SBATCH -J Infer-reasoning-16down
#SBATCH --nodes=1    
...
max_new_tokens=3000 \
mmu_image_root='./data' \
validation_prompts_file=data/geouni_mixing_data/reasoningtest_reasoning_cn.jsonl \
...
CUDA_VISIBLE_DEVICES=3 python3 inference_reasoning.py config=configs/geouni_test_512x512_16Down.yaml \
pretrained_geouni_model_path='outputs/geouni-512x512-0313-16down' \
max_new_tokens=3000 \
mmu_image_root='./data' \
...
CUDA_VISIBLE_DEVICES=0 python3 inference_mix.py config=configs/geouni_test_512x512_16Down.yaml \
pretrained_geouni_model_path='outputs/geouni-512x512-0313-16down' \
max_new_tokens=3000 \
...
CUDA_VISIBLE_DEVICES=1 python3 inference_mix.py config=configs/geouni_test_512x512_16Down.yaml \
max_new_tokens=3000 \
...
CUDA_VISIBLE_DEVICES=3 python3 inference_mix.py config=configs/geouni_test_512x512_16Down.yaml \
pretrained_geouni_model_path='outputs/geouni-512x512-0313-16down' \
max_new_tokens=3000 \
